...
**If not:** Clarify the project role before requesting access.
...
**Continue when:** Request minimum access.

**If not:** Do not grant access by implication or convenience.
...
**Continue when:** Complete the fictional packet questions.

**If not:** Do not activate access solely because training passed.
...
**If not:** Add the missing owner or decision before approval.
